...
这些规则说明了一个关键点：Fountain 的强项是“让纯文本被解释成剧本格式”，不是承载完整项目 AST。

## 我们的 Fountain-like 是什么

`fountain-like` 是 `ScreenplayAst -> readable screenplay text` 的导出投影。
...
```text
exportAstToFountainLike(ast, options) -> string
```
